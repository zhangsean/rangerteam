...
<div id='menuActions'>
  <div class='btn-group'>
    ...
    <ul id='exportActionMenu' class='dropdown-menu'>
      <li><?php commonModel::printLink('order', 'export', "mode=all&orderBy=id_desc", $lang->exportAll, "class='iframe' data-width='700'");?></li>
      <li><?php commonModel::printLink('order', 'export', "mode=thispage&orderBy=id_desc&recTotal={$pager->recTotal}&recPerPage={$pager->recPerPage}&pageID={$pager->pageID}", $lang->exportThisPage, "class='iframe' data-width='700'");?></li>
    </ul>
  </div>
