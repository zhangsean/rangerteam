...
<div id='menuActions'>
  <div class='btn-group'>
    ...
    <ul id='exportActionMenu' class='dropdown-menu'>
      ...
      <li><?php commonModel::printLink('order', 'export', "mode=thispage&orderBy={$orderBy}&recTotal={$pager->recTotal}&recPerPage={$pager->recPerPage}&pageID={$pager->pageID}", $lang->exportThisPage, "class='iframe' data-width='700'");?></li>
    </ul>
  </div>
