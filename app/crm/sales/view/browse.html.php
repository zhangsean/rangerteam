...
<div class='panel'>
  <div class='panel-heading'>
    <strong><i class='icon-list'></i> <?php echo $lang->sales->list;?></strong>
    <span class='panel-actions pull-right'>
      <?php commonModel::printLink('sales', 'admin', '', $lang->sales->admin, "class='btn btn-primary'");?>
      <?php commonModel::printLink('sales', 'create', '', $lang->sales->create, "class='btn btn-primary'");?>
    </span>
  </div>
