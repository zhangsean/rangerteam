...
$config->customer->search['fields']['contactDate']   = $lang->customer->contactDate;
...
$config->customer->search['params']['contactDate']   = array('operator' => '>=', 'control' => 'input',  'values' => '', 'class' => 'date');
