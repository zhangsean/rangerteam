...
$config->trade->search['params']['type']      = array('operator' => '=',  'control' => 'select', 'values' => $lang->trade->typeList);
...
$config->trade->search['params']['handlers']  = array('operator' => 'include', 'control' => 'select', 'values' => 'set in control');
