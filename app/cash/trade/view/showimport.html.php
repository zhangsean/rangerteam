        ...
        <tr>
          ...
          <td>
            ...
            <div class='input-group out' <?php if($trade['type'] == 'in') echo "style='display:none'"?>>
              <?php echo html::select("trader[$i]", $traderList, ($hasCustomer ? $trade['trader'] : 0), "class='form-control chosen' id='trader{$i}'" . ($hasCustomer ? '' : " style='display:none'"));?>
            ...
            <div class='input-group in' <?php if($trade['type'] == 'out') echo "style='display:none'"?>>
              <?php echo html::select("trader[$i]", $customerList, ($hasCustomer ? $trade['trader'] : 0), "class='form-control chosen' id='trader{$i}'" . ($hasCustomer ? '' : " style='display:none'"));?>
