    ...
    <div class='panel panel-sm'>
        ...
        <tr>
          <td colspan='3'>
            <div class='chart-wrapper text-center'>
              <h5><?php echo $lang->trade->in . $lang->trade->report->compare . '(' . $currencyList[$currency] . ')';?></h5>
              <div class='chart-canvas'><canvas height='395' width='800' id='incomeBarChart'></canvas></div>
            </div>
          </td>
          <td class='w-p30'>
      ...
      <table class='table active-disabled'>
        <tr>
          <td colspan='3'>
            <div class='chart-wrapper text-center'>
              <h5><?php echo $lang->trade->out . $lang->trade->report->compare . '(' . $currencyList[$currency] . ')';?></h5>
              <div class='chart-canvas'><canvas height='395' width='800' id='expenseBarChart'></canvas></div>
            </div>
          </td>
          <td class='w-p30'>
            <div class='table-wrapper'>
      ...
      <table class='table active-disabled'>
        <tr>
          <td colspan='3'>
            <div class='chart-wrapper text-center'>
              <h5><?php echo $lang->trade->profit . $lang->trade->loss . $lang->trade->report->compare . '(' . $currencyList[$currency] . ')';?></h5>
              <div class='chart-canvas'><canvas height='395' width='800' id='profitBarChart'></canvas></div>
            </div>
          </td>
          <td class='w-p30'>
            <div class='table-wrapper'>
