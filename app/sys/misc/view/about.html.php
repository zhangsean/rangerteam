...
#aboutNav > li > a.text-danger:hover {color: #fff; background-color: #d2322d}
</style>
<div class='row'>
  ...
  <div class='col-xs-6' style='border-left: 1px solid #ddd'>
    <ul class='list-unstyled' id='aboutNav'>
      <li><?php echo html::a('http://www.ranzhico.com/ranzhisaas-plans.html', "<i class='icon-cloud'></i> " . $lang->misc->yunranzhi, "target='_blank' class='text-danger'")?></li>
