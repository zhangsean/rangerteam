...
$lang->action->label->createorder    = '創建了訂單';
$lang->action->label->deletereturned = '刪除了回款';
$lang->action->label->cancelcontract = '取消了合同';
$lang->action->label->finishreturned = '完成了回款';
$lang->action->label->createcontract = '創建了合同';
$lang->action->label->editcontract   = '編輯了合同';
$lang->action->label->createdresume  = '創建了履歷';
