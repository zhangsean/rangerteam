...
$lang->action->desc->delivered       = '$date, 由 <strong>$actor</strong> 完成交付。' . "\n";
...
$lang->action->desc->delivercontract = '$date, 由 <strong>$actor</strong> 完成合同<strong>$extra</strong>的交付。' . "\n";
$lang->action->desc->receivecontract = '$date, 由 <strong>$actor</strong> 完成合同<strong>$extra</strong>的回款。' . "\n";
