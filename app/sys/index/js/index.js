...
{
    /* start ips */
    $.ipsStart(entries, $.extend({autoHideMenu: true, onBlocksOrdered: sortBlocks, onDeleteBlock: deleteBlock, onDeleteEntry: deleteEntry, onUpdateEntryMenu: updateEntryMenu, onSortEntries: sortEntries}, config, ipsLang));
});
