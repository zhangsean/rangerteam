    ...
    <div class='col-md-6 col-sm-6'><div class='card' id='webapp<?php echo $webapp->id?>'>
      ...
      <div class='card-actions webapp-actions'>
        <div class='pull-right'>
          ...
          echo isset($installeds[$webapp->id]) ? html::a('',"<i class='icon-ok icon'></i> " . $lang->webapp->installed, 'disabled="disabled" class="btn"') : html::a(inLink('install', "webappID={$webapp->id}"), $lang->webapp->install, "class='btn btn-primary'");
