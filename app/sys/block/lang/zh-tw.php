...
$lang->block->default['oa']['3']['title'] = '指派給我的任務';
...
$lang->block->default['oa']['4']['title'] = '項目列表';
...
$lang->block->moreLinkList->project['doing']    = '進行中|oa|project|index|status=doing';
$lang->block->moreLinkList->project['finished'] = '已完成|oa|project|index|status=finished';
$lang->block->moreLinkList->project['suspend']  = '已掛起|oa|project|index|status=suspend';
