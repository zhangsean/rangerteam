    ...
    <table class='table table-hover table-striped tablesorter table-data' id='taskList'>
      <thead>
        <tr class='text-center'>
          ...
          <th class='w-100px'><?php commonModel::printOrderLink('project',     $orderBy, $vars, $lang->task->project);?></th>
          ...
          <th class='w-60px visible-lg'> <?php commonModel::printOrderLink('left',        $orderBy, $vars, $lang->task->leftAB . $lang->task->lblHour);?></th>
      ...
      <tbody>
        ...
        <tr class='text-center' data-url='<?php echo $this->createLink('task', 'view', "taskID=$task->id"); ?>'>
          ...
          <td><?php echo zget($projects, $task->project);?></td>
          <td class='text-left'>
          ...
          <td colspan='11'>
            <table class='table table-data table-hover'>
              ...
              <tr class="text-center" data-url='<?php echo $this->createLink('task', 'view', "taskID=$child->id"); ?>'>
                ...
                <td class='w-100px'><?php echo zget($projects, $task->project);?></td>
                <td class='text-left'>
                ...
                <td class='w-60px visible-lg'> <?php echo $child->left;?></td>
                <td class='w-240px text-left'>
