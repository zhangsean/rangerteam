    ...
    <div class='panel project-block'>
        ...
        <div class="panel-actions pull-right">
          <div class="dropdown">
            ...
            <ul class="dropdown-menu pull-right">
              ...
              <?php if($project->status != 'suspend') echo '<li>' . html::a(inlink('suspend', "projectID=$project->id"), $lang->project->suspend, "class='switcher' data-confirm='{$lang->project->confirm->activate}'") . '</li>';?>
            </ul>
          </div>
        </div>
      </div>
      <div class='panel-body'>
        ...
        <div class='footerbar text-important'>
          ...
          <?php echo html::a(helper::createLink('task', 'browse', "projectID=$project->id"), $lang->project->enter, "class='btn btn-primary entry'");?>
        </div>
      </div>
    </div>
  </div>
