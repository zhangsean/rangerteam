( function ( utils ) {
    KM.registerWidget( 'markers', {
        tpl: "<style>" +
            ".kmui-dialog-<%= container %> .priority .icon{background:url(/js/kityminder/dialogs/markers/images/iconpriority.png) 0 0}" +
            ".kmui-dialog-<%= container %> .progress .icon{background:url(/js/kityminder/dialogs/markers/images/iconprogress.png) 0 0}" +
