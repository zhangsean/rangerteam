...
class contractModel extends model
{
    ...
    public function update($contractID)
    {
        ...
        $data     = fixer::input('post')
            ...
            ->setDefault('canceledDate', '0000-00-00 00:00:00')
            ->setDefault('deliveredDate', '0000-00-00 00:00:00')
            ->setDefault('returnedBy', '0000-00-00 00:00:00')
            ->setDefault('begin', '0000-00-00')
            ->setDefault('end', '0000-00-00')
            ->setIF($this->post->deliveredBy, 'delivery', 'done')
            ->setIF(($this->post->deliveredBy and !$this->post->deliveredDate), 'deliveredDate', $now)
            ->setIF($this->post->returnedBy, 'return', 'done')
            ->setIF(($this->post->returnedBy and !$this->post->returnedDate), 'returnedDate', $now)
