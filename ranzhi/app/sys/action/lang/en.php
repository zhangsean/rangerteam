...
$lang->action->desc->delivercontract = '$date, <strong>$actor</strong> completed delivery of <strong>$extra</strong>.' . "\n";
$lang->action->desc->receivecontract = '$date, <strong>$actor</strong> completed payment of <strong>$extra</strong>.' . "\n";
