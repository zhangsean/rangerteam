    ...
    <form method='post' id='ajaxForm'>
      <table class='table table-form w-p60'>
       <tr>
          ...
          <td><?php echo html::select('depositor', $depositorList, $balance->depositor, "class='form-control'");?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            <div class='row'>
              <div class='col-sm-9'><?php echo html::input('money', $balance->money, "class='form-control'");?></div>
              <div class='col-sm-3'><?php echo html::select('currency', $lang->depositor->currencyList, $balance->currency, "class='form-control'");?></div>
            </div>
          </td>
        </tr>
        <tr>
