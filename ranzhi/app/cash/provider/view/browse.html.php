  ...
  <table class='table table-hover table-striped tablesorter table-data'>
    <thead>
      <tr class='text-center'>
        ...
        <th class='w-160px'> <?php commonModel::printOrderLink('area',        $orderBy, $vars, $lang->customer->area);?></th>
        <th class='w-150px'> <?php commonModel::printOrderLink('industry',    $orderBy, $vars, $lang->customer->industry);?></th>
    ...
    <tbody>
      ...
      <tr class='text-center' data-url='<?php echo $this->createLink('provider', 'view', "providerID=$provider->id"); ?>'>
        ...
        <td class='actions'>
          <?php echo html::a(inlink('contact', "providerID=$provider->id"), $lang->customer->contact, "data-toggle='modal'");?>
