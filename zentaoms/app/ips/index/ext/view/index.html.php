...
entries['allapps'] = new entry('allapps', '', '所有应用', 'none', '查看所有已安装应用', 'fullscreen', null, null, null, true);
entries['profile'] = new entry('profile', '<?php echo $this->createLink('user', 'profile')?>', '个人资料', 'iframe', '查看或编辑个人资料', null, null, null, null, true);
