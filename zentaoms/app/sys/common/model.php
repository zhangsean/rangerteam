...
class commonModel extends model
{
    ...
    public function loadConfigFromDB()
    {
        ...
        if(isset($this->config->system['common'])) helper::mergeConfig($this->config->system['common']);
        if(isset($this->config->personal['common'])) helper::mergeConfig($this->config->personal['common']);
    }
