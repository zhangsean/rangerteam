 ...
 */
?>
<?php $title = "<i class='icon-plus'></i> " . $lang->product->action->adminConditions;?>
<?php include '../../common/view/header.modal.html.php';?>
<form method='post' id='ajaxForm' action="<?php echo inlink('actionCondations', "actionID={$action->id}");?>">
